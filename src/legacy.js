...
function syncNoteAccordionHeader(entry) {
    ...
    const txt = (label?.textContent || label?.innerText || "").trim() || entry.fallback || "";
...
function refreshBadges() {
    ...
    toggleElems([
        ...
        document.querySelector('[data-badge="hot_special"]')?.parentElement ||
            null,
        document.getElementById("spmlInv"),
    ], (store.inventory.hot_special || 0) > 0);
    toggleElems([
        document.getElementById("preHeader"),
        document.querySelector('[data-badge="hot_pre"]')?.parentElement ||
            null,
    ...
    const addTxt = lang === "FR" ? "Choisir" : lang === "DE" ? "W�hlen" : "Choose";
